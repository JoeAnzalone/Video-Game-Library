...
class GiantBombHelper
{
    ...
    const PLATFORM_NEC_PC_6001 = 115;
    const PLATFORM_PLAYSTATION_NETWORK_PSP = 116;
    const PLATFORM_NINTENDO_3DS = 117;
    const PLATFORM_SEGA_PICO = 118;
    const PLATFORM_SUPERGRAFX = 119;
    const PLATFORM_BALLY_ASTROCADE = 120;
    const PLATFORM_IPAD = 121;
    const PLATFORM_ZEEBO = 122;
    const PLATFORM_ANDROID = 123;
    const PLATFORM_WINDOWS_PHONE = 124;
    const PLATFORM_ACORN_ARCHIMEDES = 125;
    const PLATFORM_CASIO_LOOPY = 126;
    const PLATFORM_BANDAI_PLAYDIA = 127;
    const PLATFORM_SHARP_MZ = 128;
    const PLATFORM_PLAYSTATION_VITA = 129;
    const PLATFORM_RCA_STUDIO_II = 131;
    const PLATFORM_XAVIXPORT = 132;
    const PLATFORM_GAMEPARK_32 = 133;
    const PLATFORM_POKEMON_MINI = 134;
    const PLATFORM_EPOCH_CASSETTE_VISION = 135;
    const PLATFORM_SUPER_CASSETTE_VISION = 136;
    const PLATFORM_MEGA_DUCK = 137;
    const PLATFORM_NINTENDO_3DS_ESHOP = 138;
    const PLATFORM_WII_U = 139;
    const PLATFORM_BROWSER = 140;
    const PLATFORM_SEGA_SG_1000 = 141;
    const PLATFORM_COMMODORE_CDTV = 142;
    const PLATFORM_PLAYSTATION_NETWORK_VITA = 143;
    const PLATFORM_LEAPFROG_DIDJ = 144;
    const PLATFORM_XBOX_ONE = 145;
    const PLATFORM_PLAYSTATION_4 = 146;
    const PLATFORM_WATARA_SUPERVISION = 147;
    const PLATFORM_ACTION_MAX = 148;
    const PLATFORM_CASIO_PV_1000 = 149;
    const PLATFORM_COMMODORE_16 = 150;
    const PLATFORM_SUPER_ACAN = 151;
    const PLATFORM_LINUX = 152;
    const PLATFORM_MEMOREX_MD_2500_VIS = 153;
    const PLATFORM_OUYA = 154;
    const PLATFORM_AMAZON_FIRE_TV = 155;
    const PLATFORM_NEW_NINTENDO_3DS = 156;
    const PLATFORM_NINTENDO_SWITCH = 157;
    const PLATFORM_GAME_MASTER = 158;
    const PLATFORM_APPLE_TV = 159;
    const PLATFORM_SONY_SMC_777 = 160;
    const PLATFORM_SAM_COUPE = 162;
    const PLATFORM_VIEW_MASTER_INTERACTIVE_VISION = 163;
    const PLATFORM_FUZE_TOMAHAWK_F1 = 164;
